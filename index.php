...
<!-- <section id="banner" class="banner-section"> -->
  <!-- <div class="container"> -->
    <div class="div_zindex">
      <div class="row">
      <img src="./assets/images/bmw-vehicle-ride" alt="Girl in a jacket" width="1600" height="700">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find Your Perfect bike</h1>
            <p>We have more than a thousand bikes for you to choose. </p>
            <!-- <a href="naya.php" class="btn">Read More <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div> -->
        </div>
      </div>
    </div>
  </div>
